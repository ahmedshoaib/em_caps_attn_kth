...
class CapsNetF(nn.Module):
	def __init__(self, **kwargs):
		super(CapsNetF, self).__init__()
		self.c_net1 = CapsNet(**kwargs)
		self.c_net2 = CapsNet(**kwargs)
		self.c_net3 = CapsNet(**kwargs)
		self.c_net4 = CapsNet(**kwargs)
		self.c_net5 = CapsNet(**kwargs)
